...
class RecommenderGAE(Model):
    def __init__(self, placeholders, input_dim, num_classes, num_support,
                 ...
                 activation_function, regularization, class_weights, use_class_weights,
    ...
    def _auc(self):
        self.auc = area_under_curve(self.outputs, self.labels)

        tf.summary.scalar('area_under_curve', self.auc)
...
class RecommenderSideInfoGAE(Model):
    def __init__(self,  placeholders, input_dim, feat_hidden_dim, num_classes, num_support,
                 learning_rate, num_basis_functions, hidden, num_users, num_items, accum,
                 num_side_features, activation_function, regularization, class_weights,
                 use_class_weights, self_connections=False, **kwargs):
